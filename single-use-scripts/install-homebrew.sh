...
PACKAGES=( 'bash-completion' 'brew-cask-completion' 'm-cli' 'wget' 'coreutils' 'chromedriver' 'boost' 'boost-python' 'exercism' 'gradle' 'imagemagick' 'graphviz' 'git' 'maven' 'clang-format' 'node' 'tree' )
